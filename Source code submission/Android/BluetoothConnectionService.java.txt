...
public class BluetoothConnectionService {
    ...
    BluetoothPopUpWindow mBluetoothPopup;
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                try {
                    BluetoothPopUpWindow mBluetoothPopUpActivity = (BluetoothPopUpWindow) mContext;
