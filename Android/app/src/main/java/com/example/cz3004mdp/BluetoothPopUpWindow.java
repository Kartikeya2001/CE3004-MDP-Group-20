...
/**
 * BluetoothPopupWindow class
 * Date: 2021/08/20 - 2021/10/04
 * Android App Authors: Huang Chaoshan, Nicole Tan (Chen Jiaxin)
 */
public class BluetoothPopUpWindow extends AppCompatActivity {
        ...
        public void run() {
            try {
                if (BluetoothConnectionService.BluetoothConnectionStatus == false) {
                    ...
                    Toast.makeText(BluetoothPopUpWindow.this, "Reconnection Success", Toast.LENGTH_SHORT).show();
                }
                reconnectionHandler.removeCallbacks(reconnectionRunnable);
                retryConnection = false;
            } catch (Exception e) {
                Toast.makeText(BluetoothPopUpWindow.this, "Failed to reconnect, trying in 5 second", Toast.LENGTH_SHORT).show();
            }
        }
    };
     ...
     * Creation of the buttons and their functions for the Bluetooth Window
     *
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        otherDevicesListView = (ListView) findViewById(R.id.otherDevicesLView);
        pairedDevicesListView = (ListView) findViewById(R.id.pairedDevicesLView);
        ...
        otherDevicesListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2) {
                    ...
                    mBluetoothConnection = new BluetoothConnectionService(BluetoothPopUpWindow.this);
        ...
        bluetoothSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                ...
                if (mBluetoothAdapter == null) {
                    ...
                    Toast.makeText(BluetoothPopUpWindow.this, "Device Does Not Support Bluetooth capabilities!", Toast.LENGTH_LONG).show();
        ...
        connectBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mBTDevice == null) {
                    Toast.makeText(BluetoothPopUpWindow.this, "Please Select a Device before connecting.", Toast.LENGTH_LONG).show();
                } else {
                    startConnection();
                }
            }
        ...
        connStatusTextView = (TextView) findViewById(R.id.connectionStatusTView);
        ...
        myDialog = new ProgressDialog(BluetoothPopUpWindow.this);
    ...
    /**
     * Toggle button for bluetooth scanning
     *
     * @param view
     */
    public void toggleButtonScan(View view) {
        ...
        if (mBluetoothAdapter != null) {
            if (!mBluetoothAdapter.isEnabled()) {
                Toast.makeText(BluetoothPopUpWindow.this, "Please turn on Bluetooth first!", Toast.LENGTH_SHORT).show();
            }
    ...
    /**
     * Checking of Bluetooth Persmissions
     */
    ...
    /*
     * Broadcast Receiver for bluetooth adapter state change
     * */
    ...
    /*
     * Broadcast Receiver for if bluetooth device is found
     * */
    ...
    /*
     * Broadcast Receiver for bonding status
     * */
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothDevice.ACTION_BOND_STATE_CHANGED)) {
                ...
                if (mDevice.getBondState() == BluetoothDevice.BOND_BONDED) {
                    ...
                    Toast.makeText(BluetoothPopUpWindow.this, "Successfully paired with " + mDevice.getName(), Toast.LENGTH_SHORT).show();
                    mBTDevice = mDevice;
                }
    ...
    private BroadcastReceiver mBroadcastReceiver5 = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (status.equals("connected")) {
                ...
                Toast.makeText(BluetoothPopUpWindow.this, "Device now connected to " + mDevice.getName(), Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(BluetoothPopUpWindow.this, "Disconnected from " + mDevice.getName(), Toast.LENGTH_LONG).show();
                mBluetoothConnection = new BluetoothConnectionService(BluetoothPopUpWindow.this);

                sharedPreferences = getApplicationContext().getSharedPreferences("Shared Preferences", Context.MODE_PRIVATE);
                editor = sharedPreferences.edit();
                editor.putString("connStatus", "Disconnected");
                TextView connStatusTextView = findViewById(R.id.connectionStatusTView);
